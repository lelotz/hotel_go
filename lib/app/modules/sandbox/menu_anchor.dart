...
enum MenuEntry {
  about('About'),
  showMessage('Show Message', SingleActivator(LogicalKeyboardKey.keyA, control: true)),
  hideMessage('Hide Message', SingleActivator(LogicalKeyboardKey.keyZ, control: true)),

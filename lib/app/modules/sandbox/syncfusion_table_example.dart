...
class SyncFusionExample extends StatefulWidget {
  /// Creates the home page.
  const SyncFusionExample({Key? key}) : super(key: key);

  @override
  SyncFusionExampleState createState() => SyncFusionExampleState();
}

/// A state class of a [SyncFusionExample] stateful widget.
class SyncFusionExampleState extends State<SyncFusionExample> {
            ...
            child: Row(
              children: <Widget>[
                SizedBox(
                  height: 40.0,
                  width: 150.0,
                  child: isLoading ? loadingAnimation (size: 50) : MaterialButton(
                      color: Colors.blue,
          ...
          Expanded(
            child: Card(
              child: SfDataGrid(
                ...
                //footer: const BigText(text:'totals'),
